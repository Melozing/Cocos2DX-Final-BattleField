...
const std::string Constants::ClickButtonGameSFX = "assets_game/sounds/UI/open_board.mp3";
...
const float Constants::BulletPlayerGame2Speed = 700.0f;
const float Constants::BulletSniperGame2Speed = 200.0f;
